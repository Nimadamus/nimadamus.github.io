...
- homepage-picks-data.js
- homepage-image-system.js
- index.html homepage pick rendering
- any script that rebuilds homepage cards

RUN:
python scripts/validate_homepage_pick_image_uniqueness.py
```
