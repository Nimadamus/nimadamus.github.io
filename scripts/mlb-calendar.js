...
const ARCHIVE_DATA = [
    ...
    { date: "2026-03-29", page: "mlb-previews-archive-march-2026.html#2026-03-29", title: "MLB Analysis - March 29, 2026" },
    { date: "2026-03-28", page: "mlb-march28-content.html", title: "MLB Analysis - March 28, 2026" },
    { date: "2026-03-27", page: "mlb-previews-archive-march-2026.html#2026-03-27", title: "MLB Analysis - March 27, 2026" },
    { date: "2026-03-25", page: "mlb-previews-archive-march-2026.html#2026-03-25", title: "MLB Analysis - March 25, 2026" },
    { date: "2026-03-24", page: "mlb-previews-archive-march-2026.html#2026-03-24", title: "MLB Analysis - March 24, 2026" },
...
const pageToDateMap = {};
ARCHIVE_DATA.forEach(item => { pageToDateMap[item.page.split('#')[0]] = item.date; });
