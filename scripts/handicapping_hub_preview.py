#!/usr/bin/env python3
"""
HANDICAPPING HUB - PREVIEW WITH ADVANCED STATS
Enhanced version with:
- Home/Away records
- Current streak
- Last 5 games record
- PP%/PK% for NHL (already exists, now prominently displayed)
- Net Rating indicator for NBA

This is a PREVIEW script. User reviews output before updating production.
"""
...
OUTPUT_FILE = "handicapping-hub-preview.html"  # Preview file, not production
...
<body>
    <div class="preview-banner">⚠️ PREVIEW VERSION - Review before updating production ⚠️</div>
    <nav class="nav">
        <div class="nav-inner">
            <a href="index.html" class="logo">BET<span>LEGEND</span> (PREVIEW)</a>
        </div>
    </nav>
    <header class="header">
        <h1>Handicapping <span>Hub</span> - PREVIEW</h1>
        <p class="subtitle">{date_str} | Enhanced with ATS Records, O/U Trends & Situational Stats</p>
    </header>
    <div class="container">
        <div class="tabs">
            {tab_buttons}
    ...
    <footer>
        <p>PREVIEW VERSION - <strong>New Features:</strong> ATS Records | O/U Trends | L5 Record | Home/Away Splits | Streak | Net Rating</p>
    </footer>
    <script>
